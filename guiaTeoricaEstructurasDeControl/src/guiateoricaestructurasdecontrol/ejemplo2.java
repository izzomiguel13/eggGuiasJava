...
“No existe un valor válido para tipo de bomba” */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Escriba un número entre 1 y 4 correspondiente a su tipo de motor asociado a una bomba: ");
        ...
        default: 
        System.out.println("No existe un valór válido para el tipo de bomba.");
    }
